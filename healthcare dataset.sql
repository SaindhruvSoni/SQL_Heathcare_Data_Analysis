...
--Give a unique numeric identity to every patient

alter table healthcare add id int identity(1,1)

--Find the average age of the patients diaganosed with Cancer

select Medical_Condition,avg(age) as average_age 
from healthcare 
group by Medical_Condition

--Find out the blood-group with most patients
...
--select the Name and the medical condition of the patient who paid the biggest sum of bill

select name,round(Billing_Amount,2)as Amount
from healthcare 
where Billing_Amount=(select max(Billing_Amount) from healthcare)

--select the most used insaurance company
...
--Select the percentage of Males and Females diaganosed with medical condition(Obesity)
...
--Find the most common blood type among the patients in the hospital ranked in the descending order
...
--Find the percentage of patients in all type of medical conditions, order the results in desc order 
...
--Find the most common health condition among the patients above the age of 55
...
--Find the percentage of all blood group types, order in desc 
...
--Find the most common blood group among the male and female patients
...
--Find the most preferred hospital by patients 
...
--Find out the average billing amount for every medical condition 
...
--Find out the top 2 insaurance provider who cleared the most billing amount
...
--Find out the most prescribed medicines to the patients diaganosed with cancer
